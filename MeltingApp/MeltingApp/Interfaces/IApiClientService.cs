...
namespace MeltingApp.Interfaces
{
    public interface IApiClientService
    {
        ...
        Task<TResult> DeleteAsync<TRequest, TResult>(string methodName, Action<bool, string> successResultCallback = null) where TResult : EntityBase where TRequest : EntityBase;
    }
}
